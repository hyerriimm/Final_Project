...
const Signup = () => {
  ...
  const checkboxHandler= (e)=>{
    ...
    const userIdCheckHandler = async() => {
        ...
        try {
            const response = await axios.post('http://13.125.229.126/member/id', {idCheck: userId});
    ...
    const nicknameCheckHandler = async() => {
        ...
        try {
            const response = await axios.post('http://13.125.229.126/member/nickname', {nickCheck: nickname});
